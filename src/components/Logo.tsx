      ...
      <Container>
        <div className='mx-auto max-w-2xl pt-10 pb-4 px-4 sm:px-6 lg:max-w-7xl lg:px-8 text-gray-800 dark:text-gray-100'>
          ...
          <p className='mt-6 text-base text-zinc-600 dark:text-zinc-400'>
            ...
            Clemente, California. This site is where I keep my latest projects.
            If you're interested in having me create something for you or
            someone you know, or if you want to learn more about my art, you can
            get in touch with me through the "Request" page.
          </p>
        </div>
      </Container>
    </>
