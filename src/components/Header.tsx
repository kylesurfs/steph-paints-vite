          ...
          >
            ...
            <nav className='mt-6'>
              <ul className='-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300'>
                ...
                <MobileNavItem to='/contact'>Request</MobileNavItem>
                <MobileNavItem to='/about'>About Me</MobileNavItem>
...
function AvatarContainer({
  ...
  return (
    <div
      className={clsx(
        className,
        'ml-6 h-10 w-10 rounded-full bg-white/90 p-0.5 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:ring-white/10'
      )}
      {...props}
    />
  );
...
function Avatar({
  ...
  return (
    <NavLink
      to='/'
      aria-label='Home'
      className={clsx(className, 'pointer-events-auto ml-6')}
      {...props}
    >
      <img
        src={avatarImage}
